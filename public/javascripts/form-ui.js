$.widget("ui.form",{
  _init:function(){
    ...
    var div = jQuery("<div />",{
      css:{
        width:20,height:20,margin:10,textAlign:"center"
      }
  ...
  checkboxes:function(element)
  {
    ...
    parent.wrap("<span id='_"+$(element).attr('id')+"' class='ui-state-default ui-corner-all' style='display:inline-block;width:16px;height:16px;margin-right:5px;'/>");
    parent.parent().addClass('hover');
    parent.parent("span").click(function(event){
      $(this).toggleClass("ui-state-active");
      parent.toggleClass("ui-icon ui-icon-check");
      parent.css("padding", "0px 0px 1px")
      $(element).click();
    });
  },
